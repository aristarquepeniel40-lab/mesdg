...
**Registre des indicateurs ODD (Objectifs de développement durable) pour
l’écosystème
...
Nations Unies (source :
[unstats.un.org](https://unstats.un.org/sdgs/metadata/), récupéré août
2026), remplaçant le petit registre de 4 indicateurs initialement
embarqué dans `mecore`.

**190 indicateurs** au total : - Objectifs 1 à 12 : couverture
**intégrale** du texte officiel - Objectifs 13 à 17 : sous-ensemble
**vérifié** mais non exhaustif (le cadre officiel complet compte 234
indicateurs)
...
MIT — voir
[`LICENSE`](https://aristarquepeniel40-lab.github.io/mesdg/LICENSE). Les
données du registre proviennent d’une source officielle publique des
Nations Unies.
