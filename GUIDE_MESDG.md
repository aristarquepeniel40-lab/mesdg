...
n’est pas le cas,
[`load_sdg_indicators()`](https://aristarquepeniel40-lab.github.io/mesdg/reference/load_sdg_indicators.md)
échouera silencieusement. Testé et confirmé fonctionnel de mon côté,
mais à revérifier chez toi.
...
différents
([`search_sdg_indicators()`](https://aristarquepeniel40-lab.github.io/mesdg/reference/search_sdg_indicators.md)
pluriel,
[`sdg_indicator()`](https://aristarquepeniel40-lab.github.io/mesdg/reference/sdg_indicator.md))
pour éviter toute ambiguïté si les deux packages sont chargés en même
temps. `mesdg` est le registre à privilégier pour tout nouveau projet.
...
- [`load_sdg_indicators()`](https://aristarquepeniel40-lab.github.io/mesdg/reference/load_sdg_indicators.md)
  — le registre complet (190 lignes).
